...
module.exports = [
    {
        data: new SlashCommandBuilder().setName('fun').setDescription('🎮 Fun and Games')
            ...
            .addSubcommand(s => s.setName('compliment').setDescription('❤️ Send a compliment').addUserOption(o => o.setName('user').setRequired(true)))
    ...
    {
        data: new SlashCommandBuilder().setName('utility').setDescription('🛠️ General Utility')
            ...
            .addSubcommand(s => s.setName('weather').setDescription('☁️ Check weather').addStringOption(o => o.setName('city').setRequired(true))),
    ...
    {
        data: new SlashCommandBuilder().setName('mod').setDescription('🛡️ Staff Moderation')
            ...
            .addSubcommand(s => s.setName('warn').setDescription('⚠️ Add warning').addUserOption(o => o.setName('user').setRequired(true)).addStringOption(o => o.setName('reason').setRequired(true)))
            ...
            .addSubcommand(s => s.setName('nickname').setDescription('🏷️ Change nick').addUserOption(o => o.setName('user').setRequired(true)).addStringOption(o => o.setName('name').setRequired(true)))
    ...
    },
    {
        data: new SlashCommandBuilder().setName('roles').setDescription('🎭 Role Management')
            ...
            .addSubcommand(s => s.setName('temp').setDescription('⏱️ Temporary role').addUserOption(o => o.setName('user').setRequired(true)).addRoleOption(o => o.setName('role').setRequired(true)).addStringOption(o => o.setName('time').setRequired(true)))
    ...
    },
    {
        data: new SlashCommandBuilder().setName('admin').setDescription('👑 Admin Commands')
            ...
            .addSubcommand(s => s.setName('prune').setDescription('✂️ Kick inactive').addIntegerOption(o => o.setName('days').setRequired(true)))
    ...
    {
        data: new SlashCommandBuilder().setName('setup').setDescription('⚙️ Server Configuration')
            ...
            .addSubcommand(s => s.setName('goodbyemsg').setDescription('🗯️ Goodbye message').addStringOption(o => o.setName('text').setRequired(true)))
            .addSubcommand(s => s.setName('autorole').setDescription('🎖️ New member role').addRoleOption(o => o.setName('role').setRequired(true)))
    ...
    {
        data: new SlashCommandBuilder().setName('antimod').setDescription('🛡️ Toggle Specific Protections')
            ...
            .addSubcommand(s => s.setName('spam').setDescription('⌨️ Anti-spam toggle').addStringOption(o => o.setName('status').setRequired(true)))
    ...
    },
    {
        data: new SlashCommandBuilder().setName('ticket').setDescription('🎫 Ticket Support')
            .addSubcommand(s => s.setName('setup').setDescription('🏗️ Setup ticket panel'))
    ...
    },
    {
        data: new SlashCommandBuilder().setName('reactionrole').setDescription('✨ Reaction Role Management')
            ...
            .addSubcommand(s => s.setName('remove').setDescription('✂️ Remove from message').addStringOption(o => o.setName('msg_id').setRequired(true)).addStringOption(o => o.setName('emoji').setRequired(true)))
            .addSubcommand(s => s.setName('list').setDescription('📋 List current reaction roles')),
        async execute(interaction) { /* RR Logic */ }
    },
    {
        data: new SlashCommandBuilder().setName('poll').setDescription('🗳️ Voting System')
    ...
    {
        data: new SlashCommandBuilder().setName('say').setDescription('🗣️ Bot repeat').addStringOption(o => o.setName('msg').setRequired(true)),
        async execute(interaction) { /* Say Logic */ }
    },
    {
        data: new SlashCommandBuilder().setName('embed').setDescription('🖼️ Send custom embed').addStringOption(o => o.setName('title').setRequired(true)).addStringOption(o => o.setName('description').setRequired(true)),
